...
public interface ServerAdaptor {
    ...
    default Runnable scheduleGrpcCall(String host, int port, String serviceName, String methodName, ProxyMap headers, byte[] message, int timeoutMillis, GrpcCallResponseHandler handler) throws InterruptedException {
